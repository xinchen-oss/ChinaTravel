...
import { getCultureImageUrl, handleImageError } from '../../utils/imageHelper';
import './Culture.css';
    ...
    <div className="page">
      <div className="container">
        ...
        <article className="culture-article">
          ...
          <img src={getCultureImageUrl(article.imagen, article.categoria)} alt={article.titulo} className="culture-article__image" onError={handleImageError} />
