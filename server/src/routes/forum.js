...
router.post("/", protect, authorize(ROLES.ADMIN, ROLES.CLIENTE), createPost);

router.post("/:postId/reply", protect, authorize(ROLES.ADMIN, ROLES.CLIENTE), createReply);
router.delete("/:id", protect, authorize(ROLES.ADMIN, ROLES.CLIENTE), deletePost);
